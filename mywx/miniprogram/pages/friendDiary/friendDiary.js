...
Page({
    data: {
        ...
        cardInfoList: [
            ...
            {
                title: '好友日记1', content: '这是正文1', weather: '雨', dairy_date: '2020.5.26', mood: '哭', authority: 'false', times: 'false', year: '5年后',
                image: ['../../images/pic1.jpg', '../../images/background.png'], background: ''
            },
            {
                title: '好友日记2', content: '这是正文2', dairy_date: '2020.5.27', weather: '', mood: '', authority: '', times: '', year: '',
                image: ['../../images/code-cloud-callback-config.png', '../../images/cover.jpg'], background: ''
            },
